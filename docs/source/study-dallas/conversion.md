...
1. Download the appropriate files from UT Southwestern's {{AIRC}} website ([https://swlxaircweb.swmed.edu/](https://swlxaircweb.swmed.edu/)) to `/raid/data/shared/incoming/airc/`
