...
For a current list of dockerfiles that we have created along with code to create the docker container and singularity image, see the following [page](https://github.com/epongpipat/dockerfiles)
